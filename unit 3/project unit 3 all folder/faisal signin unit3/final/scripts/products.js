...
// document.querySelector("#headerProducts").innerHTML= header();
...
document.querySelector("#inputbox1").value = travelDetails.location;
document.querySelector("#inputbox2").value = travelDetails.checkinDate;
document.querySelector("#inputbox3").value = travelDetails.checkoutDate;
document.querySelector("#no_of_travellers").innerText = travelDetails.totalTravellers + " Travellers";
